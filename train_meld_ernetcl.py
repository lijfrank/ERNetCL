...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_speaker', action='store_true', default=False, help='use speaker,False,True')
    parser.add_argument('--rnn_model', default='GRU', help='LSTM, GRU')
    ...
    parser.add_argument('--input_in_size', type=int, default=1024, help='') # 1024
